...
func (_m *IUserRepository) CheckVerify(ctx context.Context, verificationCode string) bool {
...
func (_m *IUserRepository) Create(ctx context.Context, user *user_domain.SignUp) error {
...
func (_m *IUserRepository) DeleteOne(ctx context.Context, userID string) error {
...
func (_m *IUserRepository) FetchMany(ctx context.Context) (user_domain.Response, error) {
	ret := _m.Called(ctx)
...
func (_m *IUserRepository) GetByEmail(ctx context.Context, email string) (*user_domain.User, error) {
...
func (_m *IUserRepository) GetByID(ctx context.Context, id string) (*user_domain.User, error) {
...
func (_m *IUserRepository) GetByVerificationCode(ctx context.Context, verificationCode string) (*user_domain.User, error) {
	ret := _m.Called(ctx, verificationCode)
...
func (_m *IUserRepository) Login(ctx context.Context, request user_domain.SignIn) (*user_domain.User, error) {
...
func (_m *IUserRepository) UniqueVerificationCode(ctx context.Context, verificationCode string) bool {
	ret := _m.Called(ctx, verificationCode)
...
func (_m *IUserRepository) Update(ctx context.Context, user *user_domain.UpdateUser) error {
	ret := _m.Called(ctx, user)
...
func (_m *IUserRepository) UpdateImage(ctx context.Context, userID string, imageURL string) error {
...
func (_m *IUserRepository) UpdatePassword(ctx context.Context, user *user_domain.User) error {
	ret := _m.Called(ctx, user)
...
func (_m *IUserRepository) UpdateVerify(ctx context.Context, user *user_domain.User) (*mongo.UpdateResult, error) {
	ret := _m.Called(ctx, user)
...
func (_m *IUserRepository) UpdateVerifyForChangePassword(ctx context.Context, user *user_domain.User) (*mongo.UpdateResult, error) {
	ret := _m.Called(ctx, user)
...
// UpsertOne provides a mock function with given fields: ctx, email, user
func (_m *IUserRepository) UpsertOne(ctx context.Context, email string, user *user_domain.User) (*user_domain.User, error) {
