...
//func Migrations(ctx context.Context, db *mongo_driven.Database) error {
//	//// migration
...
//
//	seed := data_seeder.NewDepartmentSeeds(de, em)
//	err := seed.SeedDepartment(context.Background())
//	if err != nil {
//		log.Fatalf("Failed to seed department: %v", err)
//	}
//
//	log.Println("Department seeded successfully!")
//	return nil
//}
