...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/departments/create/manager": {
            "post": {
                "security": [
                    {
                        "CookieAuth": []
                ...
                "parameters": [
                    {
                        "description": "Department and Manager data",
                        "name": "Input",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/department_controller.DepartmentWithManagerInput"
                        }
                    }
                ],
                "responses": {}
    ...
    "definitions": {
        ...
        "department_controller.DepartmentWithManagerInput": {
            "type": "object",
            "properties": {
                "department": {
                    "$ref": "#/definitions/departments_domain.Input"
