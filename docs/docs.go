...
const docTemplate = `{
    ...
    "tags": [
        ...
        {
            "description": "Generates financial reports over a specified date range for analysis and tracking.",
            "name": "FinancialReport"
        },
        {
            "description": "Tracks issued invoices, including amounts, due dates, and payment status.",
            "name": "Invoices"
        },
        {
            "description": "Records payments made towards invoices, linking them to accounts and payment methods.",
            "name": "Payments"
        },
        {
            "description": "Defines tax types and rates applicable to invoices, transactions, or other financial elements.",
            "name": "Taxes"
        },
        {
            "description": "Categorizes transactions into types like income or expenses for better organization.",
        ...
        {
            "description": "Stores information about customers, including their contact details (name, email, phone, address) and basic information for future reference and order management.",
            "name": "Customer"
        },
        {
            "description": "Contains details of the products available for sale, such as product name, description, price, and stock quantity. This helps track inventory and product offerings.",
            "name": "Invoices"
        },
        {
            "description": "Contains information about individual items in each order. It tracks the products, quantities, and unit prices associated with a specific order to provide more detailed order history.",
            "name": "OrderDetails"
        },
        {
            "name": "Payments"
        ...
        {
            "description": "Tracks customer orders, including customer details, shipping information, total amount, and the status of the order (processing, shipped, or canceled).",
            "name": "SaleOrders"
        },
        {
            "description": "Manages financial transactions for accounts, tracking income and expenses, amounts, and transaction dates.",
        ...
        {
            "description": "Records shipment details, including the shipping method, dates, tracking information, and the status of the delivery to monitor the progress of the shipping process.",
            "name": "Shipping"
        },
        {
            "description": "Tracks the stock levels of products in different warehouses. It helps monitor how much stock is available and where it is located.",
            "name": "Inventory"
        },
        {
            "description": "Contains details of products such as name, description, price, and associated categories. It is central to managing what items are available for sale and for inventory control.",
            "name": "Product"
        },
        {
            "description": "Organizes products into different categories for better product classification and easier management. It allows for filtering and categorizing similar products.",
            "name": "ProductCategory"
        },
        {
            "description": "Manages purchase orders sent to suppliers. It includes order numbers, supplier references, order dates, and status, ensuring that product orders are properly tracked.",
            "name": "PurchaseOrder"
        },
        {
            "description": "Provides detailed information about the individual products in each purchase order, including quantities and prices. It links the products ordered from suppliers to their respective purchase orders.",
            "name": "PurchaseOrderDetail"
        },
        {
            "description": "Keeps records of stock adjustments, such as increases or decreases in inventory due to reasons like damage, returns, or reallocation. This ensures accurate stock levels are maintained.",
            "name": "StockAdjustment"
        },
        {
            "description": "Records the movements of products in and out of warehouses, such as when items are received (Nhập kho) or dispatched (Xuất kho). This helps track changes in inventory levels.",
            "name": "StockMovement"
        },
        {
            "description": "Stores supplier information, including contact details. This table is crucial for managing relationships with vendors and tracking where products are sourced.",
            "name": "Supplier"
        },
        {
            "description": "This table stores information about different warehouses, including their location, capacity, and basic details. It helps manage the distribution and storage of products across different facilities.",
            "name": "Warehouse"
        }
    ]
}`
