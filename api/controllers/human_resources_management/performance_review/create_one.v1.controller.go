...
// CreateOneWithEmailEmployee create the performance review's information
...
// @Router /api/v1/performance-reviews/create [post]
// @Security CookieAuth
func (p *PerformanceReviewController) CreateOneWithEmailEmployee(ctx *gin.Context) {
