...
import (
	...
	purchaseordercontroller "shop_erp_mono/internal/api/controllers/warehouse_management/purchase_order"
	...
	purchaseorderusecase "shop_erp_mono/internal/usecase/warehouse_management/purchase_order/usecase"
	"time"
)

func PurchaseOrderRouter(env *config.Database, timeout time.Duration, db *mongo.Database, group *gin.RouterGroup, cacheTTL time.Duration) {
